...
// no dependency — it's ~a screen of layout math.
...
const styles = StyleSheet.create({
  ...
  todayCircle: { borderWidth: 1, borderColor: colors.inkBorder },
  selectedCircle: { backgroundColor: colors.ink },
  dayText: { color: colors.textBody, fontSize: 14 },
  todayText: { color: colors.ink, fontWeight: '600' },
