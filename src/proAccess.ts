// src/proAccess.ts
// Fail-open Pro gate for Inkwell. Pro = the one-time unlock for extras
// (currently: more than one photo per entry; future: templates, on-this-day).
// Journaling itself — text, calendar, search, export — stays free forever.
//
